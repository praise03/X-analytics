...
export default function AboutPage() {
    ...
    return (
        ...
        <div className={`relative z-10 p-6 md:p-6 space-y-8 ${colorTheme.bg} ${colorTheme.text}`}>
            ...
            <div className={`group relative ${colorTheme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${colorTheme.border} border hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10 hover:-translate-y-1`}>
                ...
                <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                        ...
                        <h2 className="text-lg font-bold font-space-grotesk">What is Xandeum?</h2>
                    </div>
                    <p className={`${colorTheme.textMuted}  tracking-wide mb-4`}>
                    ...
                    <p className={`${colorTheme.textMuted}  tracking-wide`}>
            ...
            <div className="mt-[100px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 relative">
                    ...
                    {/* Step 1 */}
                    <div className={`group relative ${colorTheme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${colorTheme.border} border hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            style={{ background: `radial-gradient(circle at top right, #06b6d415, transparent 70%)` }}
                        ></div>
                        <div className="relative z-10">
                            <div className="flex items-center gap-4 mb-6">
                                <div className="w-12 h-12 rounded-full  flex items-center justify-center text-cyan-400 font-bold text-lg">
                                    1
                                </div>
                                <h3 className="text-lg font-bold font-space-grotesk">Choose a VPS Provider</h3>
                            </div>
                            <p className={colorTheme.textMuted} >
                    ...
                    {/* Step 2 */}
                    <div className={`group relative ${colorTheme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${colorTheme.border} border hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h3 className="text-lg font-bold font-space-grotesk">Set Up Ubuntu 24.04</h3>
                            </div>
                            <p className={colorTheme.textMuted} >
                    ...
                    {/* Step 3 */}
                    <div className={`group relative ${colorTheme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${colorTheme.border} border hover:border-pink-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            style={{ background: `radial-gradient(circle at top right, #06b6d415, transparent 70%)` }}
                        ></div>
                        <div className="relative z-10">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h3 className="text-lg font-bold font-space-grotesk">Run Installer Script</h3>
                            </div>
                            <p className={colorTheme.textMuted} >
                    ...
                    {/* Step 4 */}
                    <div className={`group relative ${colorTheme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${colorTheme.border} border hover:border-amber-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h3 className="text-lg font-bold font-space-grotesk">Start Services</h3>
                            </div>
                            <p className={colorTheme.textMuted} >
                    ...
                    {/* Step 5 */}
                    <div className={`group relative ${colorTheme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${colorTheme.border} border hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            style={{ background: `radial-gradient(circle at top right, #10b98115, transparent 70%)` }}
                        ></div>
                        <div className="relative z-10">
                            <div className="flex items-center gap-4 mb-6">
                                <div className="w-12 h-12 rounded-full 20 flex items-center justify-center text-green-400 font-bold text-lg">
                                    5
                                </div>
                                <h3 className="text-lg font-bold font-space-grotesk">Access Web GUI</h3>
                            </div>
                            <p className={colorTheme.textMuted} >
                    ...
                    <div className={`group relative ${colorTheme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${colorTheme.border} border hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10`}>
                        ...
                        <div className="relative z-10">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <h3 className="text-lg font-bold font-space-grotesk">You're Live!</h3>
                            </div>
                            <p className={colorTheme.textMuted} >
