...
export default function AboutPage() {
    ...
    if (loading) {
        return <div className="flex items-center justify-center h-screen bg-[#0a0a0a]">Loading...</div>;
    }
    ...
    return (
        ...
        <div className="relative z-10 p-6 md:p-8 space-y-8">
            ...
            {/* What is Xandeum */}
            <div className={`group relative ${theme.cardBg} backdrop-blur-xl rounded-2xl p-6 ${theme.border} border hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10 hover:-translate-y-1`}>
                ...
                <div className="relative z-10">
                    ...
                    <p className={`${theme.textMuted} text-lg tracking-wide mb-4`}>
                    ...
                    <p className={`${theme.textMuted} text-lg tracking-wide`}>
            ...
            <div className="mt-[100px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
                    ...
                    {/* Step 1 */}
                    <div className={`group relative ${theme.cardBg} backdrop-blur-xl rounded-2xl p-8 ${theme.border} border hover:border-cyan-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-500/10`}>
                        ...
                        <div className="relative z-10">
                            ...
                            <p className={theme.textMuted} style={{ fontSize: "larger" }}>
                    ...
                    {/* Step 2 */}
                    <div className={`group relative ${theme.cardBg} backdrop-blur-xl rounded-2xl p-8 ${theme.border} border hover:border-purple-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    ...
                    {/* Step 3 */}
                    <div className={`group relative ${theme.cardBg} backdrop-blur-xl rounded-2xl p-8 ${theme.border} border hover:border-pink-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            style={{ background: `radial-gradient(circle at top right, #06b6d415, transparent 70%)` }}
                        ></div>
                        <div className="relative z-10">
                    ...
                    {/* Step 4 */}
                    <div className={`group relative ${theme.cardBg} backdrop-blur-xl rounded-2xl p-8 ${theme.border} border hover:border-amber-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-amber-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                    ...
                    {/* Step 5 */}
                    <div className={`group relative ${theme.cardBg} backdrop-blur-xl rounded-2xl p-8 ${theme.border} border hover:border-green-500/50 transition-all duration-300 hover:shadow-lg hover:shadow-green-500/10`}>
                        <div className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300"
